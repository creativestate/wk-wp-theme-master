	...
	static public function bootstrap(){
		...
		$settings = new WP_Option_Settings(
			...
			array(
				...
				'partner_id'		=> 'http://NA-STS.WKglobal.com/adfs/services/trust',
				'login_type'        => 'button',
				'client_id'         => 'GPOClient',
				'client_secret'     => 'UtEI9TPZ1cHNxiwrPuqRUtfS7NSKGPEDsQz6Df04kq25ZZHbTZFUEEq6VUJYIf5C',
				'scope'             => 'openid email profile',
				'endpoint_login'    => 'https://login.wolterskluwer.com/as/authorization.oauth2',
				'endpoint_userinfo' => 'https://login.wolterskluwer.com/idp/userinfo.openid',
				'endpoint_token'    => 'https://login.wolterskluwer.com/as/token.oauth2',
