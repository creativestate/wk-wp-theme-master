<div class="wrap" id="panels-settings-page">
	<div class="settings-banner">
		...
		<span class="icon">
			<img src="<?php echo plugin_dir_url_custom(__FILE__) ?>../images/icon-layer.png" class="layer-3" />
			<img src="<?php echo plugin_dir_url_custom(__FILE__) ?>../images/icon-layer.png" class="layer-2" />
			<img src="<?php echo plugin_dir_url_custom(__FILE__) ?>../images/icon-layer.png" class="layer-1" />
		</span>
