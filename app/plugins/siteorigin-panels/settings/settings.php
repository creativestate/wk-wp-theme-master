...
class SiteOrigin_Panels_Settings {
	...
	function admin_scripts($prefix){
		...
		wp_enqueue_style( 'siteorigin-panels-settings', plugin_dir_url_custom(__FILE__) . '/admin-settings.css', array(), SITEORIGIN_PANELS_VERSION );
		wp_enqueue_script( 'siteorigin-panels-settings', plugin_dir_url_custom(__FILE__) . '/admin-settings' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array(), SITEORIGIN_PANELS_VERSION );
	}
