...
function siteorigin_panels_live_editor_frontend_scripts(){
	wp_enqueue_script(
		'live-editor-front',
		plugin_dir_url_custom(SITEORIGIN_PANELS_BASE_FILE) . '/js/live-editor/live-editor-front' . SITEORIGIN_PANELS_JS_SUFFIX . '.js',
		array( 'jquery' ),
	...
	wp_enqueue_script(
		...
		plugin_dir_url_custom(SITEORIGIN_PANELS_BASE_FILE) . '/js/live-editor/jquery.scrollTo' . SITEORIGIN_PANELS_JS_SUFFIX . '.js',
		array( 'jquery' ),
		SITEORIGIN_PANELS_VERSION
	);
	...
	wp_enqueue_style(
		'live-editor-front',
		plugin_dir_url_custom(SITEORIGIN_PANELS_BASE_FILE) . '/css/live-editor-front.css',
		array(),
		SITEORIGIN_PANELS_VERSION
	);
}
