...
function siteorigin_panels_admin_enqueue_scripts( $prefix = '', $force = false ) {
	...
	if ( $force || siteorigin_panels_is_admin_page() ) {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'so-panels-admin', plugin_dir_url_custom(__FILE__) . 'js/siteorigin-panels' . SITEORIGIN_PANELS_VERSION_SUFFIX . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-resizable', 'jquery-ui-sortable', 'jquery-ui-draggable', 'underscore', 'backbone', 'plupload', 'plupload-all' ), SITEORIGIN_PANELS_VERSION, true );
		...
		wp_localize_script( 'so-panels-admin', 'panelsOptions', array(
			...
			'prebuiltDefaultScreenshot' => plugin_dir_url_custom( __FILE__ ) . 'css/images/prebuilt-default.png',
		));
...
function siteorigin_panels_admin_enqueue_styles( $prefix = '', $force = false ) {
	if ( $force || siteorigin_panels_is_admin_page() ) {
		wp_enqueue_style( 'so-panels-admin', plugin_dir_url_custom(__FILE__) . 'css/admin.css', array( 'wp-color-picker' ), SITEORIGIN_PANELS_VERSION );
...
function siteorigin_panels_enqueue_styles(){
	...
	wp_register_style('siteorigin-panels-front', plugin_dir_url_custom(__FILE__) . 'css/front.css', array(), SITEORIGIN_PANELS_VERSION );
