<div class="wrap" id="sow-widgets-page">
	<div class="page-banner">
		...
		<span class="icon">
			<img src="<?php echo plugin_dir_url_custom(__FILE__) ?>../images/icon-back.png" class="icon-back" width="50" height="43">
			<img src="<?php echo plugin_dir_url_custom(__FILE__) ?>../images/icon-gear.png" class="icon-gear" width="26" height="26">
			<img src="<?php echo plugin_dir_url_custom(__FILE__) ?>../images/icon-front.png" class="icon-front" width="50" height="43">
		</span>
			...
			<div class="so-widget-wrap">
				<div class="so-widget so-widget-is-<?php echo $widget['Active'] ? 'active' : 'inactive' ?>" data-id="<?php echo esc_attr( $widget['ID'] ) ?>">
					...
					if( file_exists( plugin_dir_path( $widget['File'] ) . 'assets/banner.svg' ) ) {
						$banner = plugin_dir_url_custom( $widget['File'] ) . 'assets/banner.svg';
					}
