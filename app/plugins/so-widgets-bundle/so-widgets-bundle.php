...
class SiteOrigin_Widgets_Bundle {
	...
	function admin_enqueue_scripts($prefix) {
		...
		wp_enqueue_style( 'siteorigin-widgets-manage-admin', plugin_dir_url_custom( __FILE__ ) . 'admin/admin.css', array(), SOW_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-trianglify', plugin_dir_url_custom( __FILE__ ) . 'admin/trianglify' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-manage-admin', plugin_dir_url_custom( __FILE__ ) . 'admin/admin' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_BUNDLE_VERSION );
	...
	function register_general_scripts(){
		wp_register_script( 'sow-fittext', plugin_dir_url_custom( __FILE__ ) . 'js/sow.jquery.fittext' . SOW_BUNDLE_JS_SUFFIX . '.js', array( 'jquery' ), '1.2', true );
	}
