		...
		$this->register_frontend_scripts(
			array(
				array(
					...
					siteorigin_widget_get_plugin_dir_url_custom( 'sow-simple-masonry' ) . 'js/imagesloaded.pkgd' . SOW_BUNDLE_JS_SUFFIX . '.js',
					array( 'jquery' ),
					SOW_BUNDLE_VERSION
				),
				array(
					'dessandro-packery',
					siteorigin_widget_get_plugin_dir_url_custom( 'sow-simple-masonry' ) . 'js/packery.pkgd' . SOW_BUNDLE_JS_SUFFIX . '.js',
					array( 'jquery' ),
					SOW_BUNDLE_VERSION
				),
				array(
					'sow-simple-masonry',
					siteorigin_widget_get_plugin_dir_url_custom( 'sow-simple-masonry' ) . 'js/simple-masonry' . SOW_BUNDLE_JS_SUFFIX . '.js',
