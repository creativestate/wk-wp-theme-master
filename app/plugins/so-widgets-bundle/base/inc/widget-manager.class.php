...
class SiteOrigin_Widgets_Widget_Manager {
	...
	function get_plugin_dir_url_custom( $id ){
		return plugin_dir_url_custom( $this->get_plugin_path( $id ) );
	}
}
 ...
 * @return string
 */
function siteorigin_widget_get_plugin_dir_url_custom($id){
	return SiteOrigin_Widgets_Widget_Manager::single()->get_plugin_dir_url_custom($id);
}
